                ...
                <div class="flex items-center space-x-4">
                    ...
                    <?php if (isset($_SESSION['user_id'])): ?>
                        <div class="relative group">
                            ...
                            <div
                                ...
                                <a href="/orders.php" class="block px-4 py-2 text-gray-700 hover:bg-indigo-50">Мои
                                    заказы</a>
                                <?php if (isAdmin()): ?>
                    ...
                    <?php else: ?>
                        <div class="flex items-center space-x-2">
                            <a href="/login.php"
                                class="text-gray-700 hover:text-indigo-600 border border-indigo-600 px-4 py-2 rounded transition">Войти</a>
                            <a href="/register.php"
                                class="bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-700 transition">Регистрация</a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
